import e,{useState as t,useEffect as r}from"react";import o from"next/head";import i from"../components/LoadingSpinner";import n from"../components/sections/HeroSection";import a from"../components/sections/FeaturesSection";import s from"../components/sections/FAQSection";import m from"../components/layout/Navbar";import d from"aos";import{initAOS as c}from"../utils/aos-config";export default function $(){let[e,o]=t(!0);return(r(()=>{let e=setTimeout(()=>o(!1),2e3);return()=>clearTimeout(e)},[]),r(()=>{e||c()},[e]),e)?<div style={{minHeight:"100vh",width:"100vw",background:"var(--background, #ffffff)",position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:9999}}>
      ...
      <n data-aos="fade-up"data-aos-delay="200"/>
